...
static void register_stream_lees_edwards_functions() {
    add_stream_lees_edwards_array_func(&stream_lees_edwards_arrays, &stream_lees_edwards_baseline_flops, "Stream Lees Edwards - Arrays Bl");
    add_stream_lees_edwards_struct_func(&stream_lees_edwards_baseline, &stream_lees_edwards_baseline_flops, "Stream Lees Edwards - Structs Bl");
}
