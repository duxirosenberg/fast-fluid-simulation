...
a c style implementation, which does not use numpy. The goal is to
make the code more readable and easier to understand for later
translating to C.
"""
...
def main():
    ...
    #Store F initial conditions
    np.savetxt('../py_baseline/initial_conditions.csv', F, delimiter=',')
    ...
    np.savetxt('../py_baseline/py_baseline.csv', F, delimiter=',')
